...
$query -> execute();
$_SESSION['delmsg']="Celebrant deleted scuccessfully ";
...
<head>
    ...
    <title>Anniversary Records Management System | Manage Celebrant</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Manage Celebrant</h4>
    </div>
