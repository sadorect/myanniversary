...
<head>
    ...
    <title>Anniversary Records Management System |  Wedding Celebrants</title>
...
{   
    ...
    ?>                              
                                        <tr class="odd gradeX" id="<?php echo $sid; ?>">
                                            ...
                                            <td class="center" contenteditable="false" id="<?php echo 'CelebrantName:' .$result->id;?>"><?php echo htmlentities($result->CelebrantName);?></td>
                                            <td class="center" contenteditable="false" id="<?php echo 'MobileNumber:'. $result->id;?>"><?php echo "0".htmlentities($result->MobileNumber);?></td>
                                            <td class="center" id="updated"><?php echo anniversaryType($result->CatId);?></td>
                                            <td class="center" contenteditable="false" id="<?php echo 'aDate:'. $result->id;?>"><?php echo $result->aDate;?></td>
                                            <td class="center">
