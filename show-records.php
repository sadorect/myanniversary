...
<head>
    ...
    <title>Anniversary Records Management System |  Celebrants</title>
...
<?php 
$sid=$_SESSION['stdid'];
$sql='SELECT id,CelebrantName,MobileNumber,CatId,DATE_FORMAT(AnniversaryDate, "%b %d") as aDate FROM tblbooks where StudentId=:sid ORDER BY MONTH(AnniversaryDate) ASC';
